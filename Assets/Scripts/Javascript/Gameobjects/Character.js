...
function CharacterObject() 
{
	...
	this.Transform.RelativePosition.x = 400;
	this.Transform.RelativePosition.y = 400;

	this.Transform.Position = new Vector();

	this.Transform.Size = new Vector();
	this.Transform.Size.x = 125;
	this.Transform.Size.y = 187;
	...
	this.SetSpriteSheet = function(_img, _sizeFrame, _animationLength) 
	{
		...
		this.Renderer.Animation.totalAnimationLength = _animationLength || 0.5; //@Correction
	...
	this.Start = function() 
	{
		if (!this.started) {
			...
			this.SetSpriteSheet(Images["character-sp"], new Vector(125,187), 1);
	...
	{
		//ctx.drawImage(Images["character"], 150, 150);
		...
		{
			this.Transform.RelativePosition.y -= this.Velocity.y;
